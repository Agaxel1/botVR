class fasttype {
     ...
     * @param {any}} [options.sentence] a setence to be typed
    ...
    constructor(options) {
        ...
        if(!options.time) throw new TypeError('gamer-discord-utils Error: Missing argument time');
        if(typeof options.time !== 'number') throw new TypeError('gamer-discord-utils Error: time must be a number')
        
        if(!options.startMessage) throw new TypeError('gamer-discord-utils Error: Missing argument startMessage');
        if(typeof options.startMessage !== 'string') throw new TypeError('gamer-discord-utils Error: startMessage must be a string');
