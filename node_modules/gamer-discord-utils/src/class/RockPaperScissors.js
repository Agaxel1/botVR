class RPS {
    ...
    constructor(options) {
      ...
      if(!options.opponent) throw new Error('gamer-discord-utils Error: Missing arguemnt opponent')

      if(!options.acceptMessage) throw new Error('gamer-discord-utils Error: Missing argument acceptMessage')
      if(typeof options.acceptMessage !== 'string') throw new Error('gamer-discord-utils Error: acceptMessage must be a string')
