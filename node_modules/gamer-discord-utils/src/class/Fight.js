...
class fight {
  ...
  */
  ...
  constructor(options) {
  if(!options.acceptMessage) throw new Error('gamer-discord-utils Error: Missing argument acceptMessage')
  if(typeof options.acceptMessage !== 'string') throw new Error('gamer-discord-utils Error: Accept message must be a string')
  
  if(!options.hitButtonText) throw new TypeError('gamer-discord-utils Error: Missing argument hitButtonText')
  if(typeof options.hitButtonText !== 'string') throw new Error('gamer-discord-utils Error: hitButtonText must be a string')
  
  if(!options.hitButtonColor) throw new TypeError('gamer-discord-utils Error: Missing argument hitButtonColor')
  if(typeof options.hitButtonColor !== 'string') throw new Error('gamer-discord-utils Error: hitButtonColor must be a string')
  
  if(!options.healButtonText) throw new TypeError('gamer-discord-utils Error: Missing argument healButtonText')
  if(typeof options.healButtonText !== 'string') throw new Error('gamer-discord-utils Error: healButtonText must be a string')
  
  if(!options.healButtonColor) throw new TypeError('gamer-discord-utils Error: Missing argument healButtonColor')
  if(typeof options.healButtonColor !== 'string') throw new Error('gamer-discord-utils Error: healButtonColor must be a string')
  
  if(!options.cancelButtonText) throw new TypeError('gamer-discord-utils Error: Missing argument cancelButtonText')
  if(typeof options.cancelButtonText !== 'string') throw new Error('gamer-discord-utils Error: cancelButtonText must be a string')
  
  if(!options.cancelButtonColor) throw new TypeError('gamer-discord-utils Error: Missing argument cancelButtonColor')
  if(typeof options.cancelButtonColor !== 'string') throw new Error('gamer-discord-utils Error: cancelButtonColor must be a string')
  
  if(!options.message) throw new Error('gamer-discord-utils Error: Missing argument message')
  
  if(!options.client) throw new Error('gamer-discord-utils Error: Missing argument client')
  
  if(!options.challenger) throw new Error('gamer-discord-utils Error: Missing argument challenger')
  
  if(!options.opponent) throw new Error('gamer-discord-utils Error: Missing argument opponent')
