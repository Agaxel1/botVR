...
constructor(options) {
  if(!options.word) throw new TypeError('gamer-discord-utils Error: Missing argument word')
  if(typeof options.word !== 'string') throw new TypeError('gamer-discord-utils Error: word must be a string')
  
  if(!options.colorReshuffleButton) throw new TypeError('gamer-discord-utils Error: Missing argument colorReshuffleButton')
  if(typeof options.colorReshuffleButton !== 'string') throw new TypeError('gamer-discord-utils Error: colorReshuffleButton must be a string')
  
  if(!options.messageReshuffleButton) throw new TypeError('gamer-discord-utils Error: Missing argument messageReshuffleButton')
  if(typeof options.messageReshuffleButton !== 'string') throw new TypeError('gamer-discord-utils Error: messageReshuffleButton must be a string')
              
  if(!options.colorCancelButton) throw new TypeError('gamer-discord-utils Error: Missing argument colorCancelButton')
  if(typeof options.colorCancelButton !== 'string') throw new TypeError('gamer-discord-utils Error: colorCancelButton must be a string')
  
  if(!options.messageCancelButton) throw new TypeError('gamer-discord-utils Error: Missing argument messageCancelButton')
  if(typeof options.messageCancelButton !== 'string') throw new TypeError('gamer-discord-utils Error: messageCancelButton must be a string')

  if(!options.winMessage) throw new TypeError('gamer-discord-utils Error: Missing argument winMessage')
  if(typeof options.winMessage !== 'string') throw new TypeError('gamer-discord-utils Error: winMessage must be a string')
  
  if(!options.client) throw new TypeError('gamer-discord-utils Error: Missing argument client')
  
  if(!options.message) throw new TypeError('gamer-discord-utils Error: Missing argument message')
