class TicTacToe {
    ...
    constructor(options) {
      ...
      if(typeof options.xEmoji !== 'string') throw new TypeError('gamer-discord-utils Error: xEmoji must be a string')

      if(!options.oEmoji) throw new TypeError('Missing argument: oEmoji')
      if(typeof options.oEmoji !== 'string') throw new TypeError('gamer-discord-utils Error: oEmoji must be a string')

      if(!options.xColor) throw new TypeError('Missing argument: xColor')
      if(typeof options.xColor !== 'string') throw new TypeError('gamer-discord-utils Error: xColor must be a string')

      if(!options.oColor) throw new TypeError('Missing argument: oColor')
      if(typeof options.oColor !== 'string') throw new TypeError('gamer-discord-utils Error: oColor must be a string')

      if(!options.opponent) throw new TypeError('gamer-discord-utils Error: Missing argument opponent')
