    ...
    async execute(client, message, commandArgs) {
        ...
        try {
            ...
            if (commandArgs[0] === 'departamento') {
                ...
                if (isNaN(numeroDepartamento) || numeroDepartamento < 1 || numeroDepartamento > 4) {
                    message.channel.send('Número de departamento inválido. Debe ser un número del 1 al 4.');
                    return;
                }
                ...
                switch (numeroDepartamento) {
                    case 1:
                        ...
                        break;
                    case 2:
                        nombreDepartamento = 'Transito';
                        break;
                    case 3:
                        nombreDepartamento = 'Investigaciones';
                        break;
                    case 4:
                        nombreDepartamento = 'Carreteras y Pueblos';
                        break;
                    default:
            ...
            if (commandArgs[0] === 'puesto') {
                ...
                // Verificar que el número del puesto sea válido (1-10)
                if (isNaN(numeroPuesto) || numeroPuesto < 1 || numeroPuesto > 10) {
                    message.channel.send('Número de puesto inválido. Debe ser un número del 1 al 10.');
                    return;
                }
                ...
                switch (numeroPuesto) {
                    case 1:
                        nombrePuesto = 'Sub. Oficial';
                        break;
                    case 2:
                        nombrePuesto = 'Oficial';
                        break;
                    case 3:
                        nombrePuesto = 'Cabo';
                        break;
                    ...
                    case 7:
                        ...
                        break;
                    case 8:
                        nombrePuesto = 'Inspector';
                        break;
                    case 9:
                        nombrePuesto = 'Teniente Coronel';
                        break;
                    case 10:
                        nombrePuesto = 'Comandante';
                        break;
                    default:
                        ...
                        if (nombre.includes('(LG)')) {
                            ...
                            switch (miembro.Group) {
                                ...
                                case 2:
                                    ...
                                    break;
                                case 3:
                                    nombreDepartamento = 'Investigación';
                                    break;
                                case 4:
                                    nombreDepartamento = 'Carreteras';
                                    break;
                                default:
                                    nombreDepartamento = 'Desconocido';
                                    break;
