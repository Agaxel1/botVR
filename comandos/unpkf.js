...
module.exports = {
  ...
  async execute(client, message, commandArgs) {
    ...
    try {
      ...
      // Aplicar el PKF
      const sqlUpdate = 'UPDATE PlayaRP SET PKFaccion = 0 WHERE Name = ?';
      await executeQuery(sqlUpdate, [name_s]);

      message.channel.send(`Al usuario ${name_s} se le ha quitado el PKF.`);
    } catch (error) {
