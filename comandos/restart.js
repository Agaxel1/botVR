...
module.exports = {
    name: 'restart',
    alias: ['reiniciar'],
    description: 'Reinicia el servidor de VIDA ROL.',
  ...
  return;
      ...
      axios.post(`https://game.papu.host/api/client/servers/${SERVER_ID}/power`, {
        ...
        .then(response => {
          ...
          message.channel.send('El servidor de VIDA ROL se reiniciará.');
        })
        .catch(error => {
          console.error('Error al reiniciar el servidor de VIDA ROL:', error.message);
          message.channel.send('Hubo un error al reiniciar el servidor.');
        });
    },
  };
