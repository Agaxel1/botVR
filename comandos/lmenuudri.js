    ...
    async execute(client, message, commandArgs) {
        ...
        try {
            ...
            if (commandArgs[0] === 'escuadron') {
                ...
                if (isNaN(numeroDepartamento) || numeroDepartamento < 1 || numeroDepartamento > 3) {
                    message.channel.send('Número de departamento inválido. Debe ser un número del 1 al 3.');
                    return;
                }
                ...
                switch (numeroDepartamento) {
                    case 1:
                        nombreDepartamento = 'Verde';
                        break;
                    case 2:
                        nombreDepartamento = 'Cobra';
                        break;
                    case 3:
                        nombreDepartamento = 'Negro';
                        break;
                    default:
